...
public class LineGraph extends Applet {
  ...
  public void paint(Graphics g) {
    ...
    //縦線データー線記入
    if(250-20-(int)(205*pa[0]/max) > 15+10+51*3){
      GradientPaint gp = new GradientPaint(15+45,15+10+51*3,Color.RED,15+45,250-15,Color.GRAY);
      g2.setPaint(gp);
   ...
   for(i=0;i<4;i++){
    ...
    for(i=0;i<8;i++){
      ...
      if(i==7){
        ...
        g.drawLine((int)(15+40+335*i/7)+5,5+250-20-(int)(205*pa[i]/max),5+(int)(15+40+335*(i+1)/7),5+250-20-(int)(205*pa[i+1]/max));
      }
    }
  }
}